...
This is where fidgets come in. I was an early adopter of the [Fidget Cube](https://www.antsylabs.com/products/fidget-cube-the-original-fidget-toy) when it first appeared, and I’m a little bit addicted to buying new fidgets. They’re everywhere in my house, and I even have [one which fits in the little coin pocket of my jeans](https://amzn.eu/d/0fsO1vu8). I love them.

## Have nice things

Doing hard things is a little bit less hard when you enjoy using the tools you need to use. I think that’s why I’ve always been a bit obsessed with buying nice stuff for my desk, like a [really nice pen](https://www.lamy.com/en/lamy-swift/), or a [mechanical keyboard](https://www.keychron.com/products/keychron-k3-wireless-mechanical-keyboard).

For me, the quality is a necessity as much as it is a luxury: I’m more likely to sit down and do work if I can look forward to typing on my lovely keyboard, or if my code editor has a [really nice colour scheme](https://draculatheme.com) and font. (Yes, I have [paid](https://philpl.gumroad.com/l/dank-mono) [money](https://www.monolisa.dev) for programming fonts.) Spending a bit of extra money on my physical and digital tools is an investment in my future productivity. At least, that’s what I’m telling myself.

## Use timers

I’m a _huge_ fan of the [pomodoro technique](https://www.pomodorotechnique.com). There is something magical about the act of starting a timer: it seems to kick my brain into gear and break down whatever wall is in the way of my executive function.

I have a digital timer called [Tomito](https://tomito.app) installed on my Mac, which displays a little countdown in the corner of my display. I’ve hooked it up to [Raycast](https://www.raycast.com) and set up keyboard shortcuts, so starting a 25-minute timer is as easy as hitting ⌥ (Option) + Space.

The other advantage of using timers is that it reminds me to take frequent breaks. This prevents unwanted [hyperfocus](https://www.webmd.com/add-adhd/hyperfocus-flow) and ensures I can work sustainably for longer each day.
...
I no longer look at social media (including YouTube) or news websites for longer than 45 minutes a day. I use an app called [Jomo](https://jomo.so), which blocks these distractions by default but allows me 3 “breaks” of up to 15 minutes each day.
