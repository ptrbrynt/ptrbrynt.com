...
I’m not quite that upset about it. To be absolutely clear: the Trump administration is utterly deplorable in every way. _However_, it’s pretty clear what Apple’s motivation is for&nbsp;“bending the knee”.

Fundamentally, Apple is a publicly traded company. That means it has one primary purpose: **to deliver value to its shareholders**. _Everything_&nbsp;it does serves that goal in one way or another.
