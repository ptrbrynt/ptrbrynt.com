...
Here are a few ways I use my phone to _improve_ my life.

## 1. Reading independent writing

I'm trying to be a more active participant in the "IndieWeb". To this end, I use my phone to read blogs, primarily using RSS and the [NetNewsWire](https://netnewswire.com/) app. I also use [Obsidian](https://obsidian.md) to write posts, although I much prefer typing on my laptop.
...
A bunch of exciting tools and services are cropping up around this (such as [Bubbles](https://bubbles.town/)). I really do think blogs are back.
...
I've used a bunch of different services for this over the years including [FoodNoms](https://foodnoms.com/) and [Lifesum](https://lifesum.com/), but the one I'm using right now is [Alma](https://www.alma.food/). This works great for me for the simple reason that it has the fastest data input method: I can literally take a photo of my food, and provide a very brief description, then let Alma's AI figure out the rest.
...
I _love_ doing the daily [New York Times crosswords](https://www.nytimes.com/crosswords), and other puzzles. It's a great way to fill time, and it's impossible to get addicted because you can stop when you've completed the day's puzzles.
